...
test("applyGroove(): Custom Media Sizes, Up Strategy", () => {
  ...
  let config = { mediaBreakpoints: { xl: 1300, lg: 1000, md: 850, sm: 701, xs: 700 }, mediaStrategy: "up" };
  ...
  config = { mediaBreakpoints: { lg: 1000, md: 850 }, mediaStrategy: "up" };
...
test("applyGroove(): Custom Media Sizes, Down Strategy", () => {
  ...
  // All media breakpoints overridden
  let config = { mediaBreakpoints: { xl: 1300, lg: 1299, md: 850, sm: 700, xs: 550 }, mediaStrategy: "down" };
  ...
  // Subset of media breakpoints overridden
  config = { mediaBreakpoints: { md: 850, sm: 650 }, mediaStrategy: "down" };
